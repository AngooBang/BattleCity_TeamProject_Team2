...
HRESULT EnemyTank::Init()
{
    ...
    m_shape.left = m_pos.x - (m_bodySize.x / 2);
    m_shape.top = m_pos.y - (m_bodySize.y / 2);
    m_shape.right = m_shape.left + m_bodySize.x;
    m_shape.bottom = m_shape.top + m_bodySize.y;
